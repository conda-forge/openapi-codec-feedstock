...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/openapi-codec-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/openapi-codec-feedstock)
...
Once the `conda-forge` channel has been enabled, `openapi-codec` can be installed with:

```
conda install openapi-codec
```

It is possible to list all of the versions of `openapi-codec` available on your platform with:
